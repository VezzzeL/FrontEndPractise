...
let samPointsDisplay = "Sam earned " + samPoints + " points of " + maxPoints;
let alexPointsDisplay = "Alex earned " + alexPoints + " points of " + maxPoints;
let jessiePointsDisplay = "Jessie earned " + jessiePoints + " points of " +
  maxPoints;
...
let classAvgDisplay = classAveragePoints.toFixed(2);
...
console.log("The class average was " + classAveragePoints + " points or " +
classAvgDisplay + ".");
